...
public class BattleSettings 
{
    ...
    /**
     * Prompts the user to enter an integer corresponding to a petType until a valid type
     * is chosen.
     * @param playerName the name of the player, used in the prompt
     * @return the chosen pet type
     */
